    ...
    for (const [teamA, teamB] of partitions(sorted)) {
      ...
      const suggestion = {
        ...
        explanation: {
          ...
          mode,
          loneFemalePolicy: loneFemalePolicy(teamA, teamB, mode === "MIXED_DOUBLES"),
