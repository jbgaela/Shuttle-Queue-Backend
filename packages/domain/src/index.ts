    ...
    for (const [teamA, teamB] of partitions(sorted)) {
      ...
      const suggestion = {
        ...
        explanation: {
          ...
          fairness: { minimumGames: candidateMinimumGames, minimumGamesCount: lowestGames, manualOverride: false },
        },
      };
